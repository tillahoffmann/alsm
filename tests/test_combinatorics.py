...
def test_var_combinatorics(directed: bool, within: bool):
    ...
    combinatorics of counting contributions to the variance of aggregate relational
    data.

    Args:
        directed: Whether the network is directed.
        within: Whether the variance of aggregate connection volumes within or between
    ...
    if within:
        ...
        if directed:
            ...
            # For the 'ijil' option, we have n choices for i, n - i choices for j, and
            # n - i - 1 choices for l. Evaluating
            # Factor[Sum[(n - i - 1) (n - i), {i, 1, n}]] gives.
...
def test_cov_combinatorics(directed: bool, within: bool):
    """
    This test does not test any code in the repository. It runs numerical checks on the
    combinatorics of counting contributions to the covariance of aggregate relational
    data.

    Args:
        directed: Whether the network is directed.
        within: Whether the covariance of aggregate connection volumes should include
            within-group connections, i.e. Y_{aa}Y_{ac} rather than Y_{ab}Y_{ac}.
    """
    n1 = 11
    n2 = 13
    n3 = 17
